...
export default function EmployerPayments() {
  ...
  useEffect(() => {
    const fetchPayments = async () => {
      ...
      try {
        // Get employer's company from c3_users -> c3_companies
      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-muted-foreground">
            {companyName ? `Payment history for ${companyName}` : 'View your payment history and transactions'}
          </p>
        </div>
          ...
          <Card>
            ...
            <CardContent>
              {isLoading ? (
                ...
                <div className="text-2xl font-bold">
                  {payments.filter((p) => p.payment_status?.toLowerCase() === 'pending').length}
                </div>
              )}
            </CardContent>
          </Card>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>All C3 contribution payments for your company</CardDescription>
          </CardHeader>
          <CardContent>
            {isLoading ? (
                  ...
                  <TableBody>
                    {payments.map((payment) => (
                      <TableRow key={payment.id}>
                        ...
                        <TableCell>{payment.period_year || 'N/A'}</TableCell>
