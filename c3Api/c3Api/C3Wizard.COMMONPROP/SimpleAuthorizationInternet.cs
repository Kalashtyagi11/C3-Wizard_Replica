    ...
    public static PtsV2PaymentsPost201Response Run()
    {
      ...
      try
      {
        ...
        var configDictionary = new Dictionary<string, string>
        {
            ...
            { "apiKey", "c95c9eda-f953-470e-ae3e-301e1dd78a58" },
            { "apiSecret", "FkaYDaP1xAwrfXl42xE8wVS2z8UgrPmjjZ8Hh9v36ao=" },
            { "enableLog", "true" },
            { "authenticationType", "http_signature" }, // or JWT if using token-based authentication
            { "runEnvironment", "CyberSource.Environment.Sandbox" } // Change to production as needed
        };
