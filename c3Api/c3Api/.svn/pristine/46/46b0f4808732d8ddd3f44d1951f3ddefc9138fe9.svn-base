...
namespace C3Wizard.COMMONPROP
{
    ...
    {
        string INSERT_SPNAME
        {
            get;
        }

        string UPDATE_SPNAME
        {
            get;
        }

        string DELETE_SPNAME
        {
            get;
        }
        ...
        //string? NOTES_TABLE_RECORD_ID
        //{
        //    get;
        //    //set;
        //}

        string FIND_QUERY(ref Object[] parameters);
    }

    //****************************************************************************
    //*************  Added by Bharat Dhall *******************
    //****************************************************************************
    public enum ApprovalTables
    {
        NonAPChecks = 1,
        PurchaseOrder = 2
    }
    ...
    //****************************************************************************
    //*************  Added by Bharat Dhall [29 December, 2008] *******************
    //****************************************************************************
    ...
    /// <summary>
    /// Always use StringEnum.GetStringValue(Enum enumtype) to get string value of enumerator.
    /// </summary>
