...
const VarifyProcess = () => {
  ...
  const handleLogin = async (formValue) => {
    ...
    const typeMFA = 'mailVarifyProcess';
    const { code } = formValue;

    const userData = await dispatch(VerifyMFAOtp({ userId: storedUserId, type: typeMFA, code }))
      .unwrap()
      .then((res) => {
  ...
  const validationSchema = Yup.object().shape({
    code: Yup.string().required('Verification email OTP is required'),
  });
            ...
            <Col lg="12" className="loginContainer">
              <Card>
                <CardBody className="p-4 m-1">
                  ...
                  <h5 className="mb-3 text-center cutom_heading"> Verification Email OTP </h5>
                  <div
                  ...
                  >
                    OTP has been sent to your registered email. Please check and enter it to proceed
                    with login.
                  </div>
                  ...
                  <Formik
                    ...
                    render={({ errors, touched }) => (
                      <Form>
                        <FormGroup>
                          <Label htmlFor="code">
                            Verification Email OTP <span className="text-danger">*</span>
                          </Label>
                          <Field
                            name="code"
                            type="text"
