...
const OfflinePaymentReportNotWorking = () => {
    ...
    if (receiptNumber.trim()) {
      ...
      try {
        const result = await dispatch(
          adminSearchResultsNW({ receiptId: receiptNumber, userId: userID }),
        ).unwrap();
        const paymentMode = result?.PaymentNWResponse?.data || null;
  ...
  useEffect(() => {
    if (headerID) {
      dispatch(getReportedListNW({ HeaderId: headerID }));
    }
  }, [headerID, dispatch]);
                          ...
                          <Col md={12}>
                            <FormGroup>
                              ...
                              <Input
                                ...
                                name="needToPay"
                                id="needToPay"
                                value={formData.needToPay ? `$${formData.needToPay}` : ''}
                                onChange={handleInputChange}
                                placeholder="Enter value"
                              />
                            </FormGroup>
                            ...
                            <table className="table table-hover mb-0 white-space tableword-wrap">
                              <tbody>
                                ...
                                <tr>
                                  ...
                                  {getListReport && getListReport.length > 0 ? (
                                    getListReport.map((item, index) => (
                                      <td key={index}>${item?.levy?.toFixed(2) ?? '0.00'}</td>
                                    ))
                                  ) : (
                                    <td>0.00</td>
                                  )}
                                ...
                                <tr>
                                  ...
                                  {getListReport && getListReport.length > 0 ? (
                                    getListReport.map((item, index) => (
                                      <td key={index}>${item?.severance?.toFixed(2) ?? '0.00'}</td>
                                    ))
                                  ) : (
                                    <td>0.00</td>
                                  )}
                          ...
                          getListReport.map((item, index) => (
                            <div key={index} className="mt-3">
                              ...
                              <div className="feature mt-2">
                                ...
                                <div>${Number(item?.levy || 0).toFixed(2)}</div>
                              </div>
                              ...
                              <div className="feature mt-2">
                                ...
                                <div>${Number(item?.severance || 0).toFixed(2)}</div>
                              </div>
...
export default OfflinePaymentReportNotWorking;
