...
const UserManagement = () => {
  ...
  const { PersonalData, loading: isLoading } = useSelector((state) => state.userManagementSlice);
  ...
  const employerPermission = savedRoles.find((role) => role.description === 'USER PROFILE');
