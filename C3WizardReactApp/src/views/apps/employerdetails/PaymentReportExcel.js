...
import PaymentDownloadExcel from '../component/AdminPaymentDownload';

const PaymentReportExcel = () => {
  ...
  const handleChangeType = (selected) => {
    ...
    console.log('Selected Type:', selected.value);
  };
  ...
  useEffect(() => {
    const fetchDashboardData = async () => {
      ...
      try {
        ...
        console.error('Failed to load dashboard payment:', error);
      } finally {
  ...
  return (
    <>
      <Helmet>
        <title> Payment History Report - C3Wizard</title>
      </Helmet>
        ...
        <>
          <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <ul className="d-flex align-items-center mt-3 gap-2 list-unstyled">
              ...
              <li>-</li>
              <li className="fw-medium">
                <span className="d-flex align-items-center gap-1 text-muted">Payment History</span>
              </li>
            </ul>
          </div>
        </>
                    ...
                    <div className="row">
                      <div className="col-xl-12">
                        <div className="card">
                          <div className="card-header py-3 bg_ligh">
                            <div className="row">
                              <div
                                className={
                                  CategoryType === 'SSB'
                                    ? 'col-xl-10 d-flex align-items-center '
                                    : 'col-xl-10  d-flex align-items-center '
                                }
                              >
                                <>
                                  <div className="col-md-3  col-lg-3 col-xl-3 me-1">
                              ...
                              <div className="col-md-2 col-lg-2 col-xl-2 text-end d-flex align-items-center position-relative">
                                <div className="position-absolute bottom-0 end-0">
                                  <PaymentDownloadExcel
                          ...
                          <div className="card">
                            <div className="card-header py-3 bg_ligh">
                              <h4 className="header-title mb-0 text-success">Payment History</h4>
                            </div>
                                ...
                                <table className="table new_table table-hover mb-0">
                                  <thead>
                                    <tr className="border-b">
                                      ...
                                      <th className="td-text-align">Year&nbsp;&nbsp;</th>
                                      ...
                                      {!(
                                        CategoryType === 'SELFEMPLOYEE' ||
                                        selectedType?.value === 'SelfEmployee'
                                      ) && <th className="td-text-align">Severance</th>}
                                      <th className="td-text-align"> Payment Amount</th>
...
export default PaymentReportExcel;
