...
import ReconcilationDownloadExcel from '../component/AdminReconcilationDownload';

const ReconcilationReportExcel = () => {
  ...
  return (
    <>
      <Helmet>
        <title> Reconciliation History Reports - C3Wizard</title>
      </Helmet>
      <div id="layout-wrapper">
        ...
        <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
          <ul className="d-flex align-items-center mt-3 gap-2 list-unstyled">
            ...
            <li>-</li>
            <li className="fw-medium">Reconciliation History</li>
          </ul>
        </div>
        {isLoading ? (
          <Loader />
                      ...
                      <div className="col-xl-12">
                        <div className="card">
                          <div className="card-header py-3 bg_ligh">
                            <div className="row">
                              <div className="col-md-3 col-lg-3  col-xl-3 px-1">
                                <div className="mb-3">
                              ...
                              <div className="col-md-2 col-lg-2 col-xl-2 px-0">
                                <button
                                  ...
                                  type="submit"
                                  style={{ height: 'px', marginTop: '30px' }}
                                >
                                  {loadingSearch ? (
                                    <>
                              ...
                              <div className="col-md-4 col-lg-4 col-xl-4 text-end  position-relative">
                                <div
                                  className="position-absolute  "
                                  style={{ bottom: '18px', right: '15px' }}
                                >
                                  <ReconcilationDownloadExcel
                                    reconciledOption={reconciledOption?.value ?? null}
                                    cardHolderOption={cardHolderOption?.value ?? null}
                                  />
                                </div>
                              </div>
                            </div>
                                          ...
                                          <tr key={id}>
                                            ...
                                            {!hiddenFields.includes('ReconciledDate') && (
                                              <td>
                                                {item?.ReconciledDate &&
                                                typeof item.ReconciledDate === 'string'
                                                  ? moment(item.ReconciledDate).format(
                                                      'DD-MMM-YYYY',
                                                    )
                                                  : ''}
                                              </td>
                                            ...
                                            {!hiddenFields.includes(
                                              ...
                                              <td>
                                                {formatValue(item?.TransactionReferenceNumber)}
                                              </td>
                                            )}
...
export default ReconcilationReportExcel;
