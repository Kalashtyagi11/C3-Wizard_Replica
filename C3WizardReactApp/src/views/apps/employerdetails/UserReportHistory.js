...
import UserHIstoryDownload from '../component/UserHIstoryDownload';
...
const UserReportHistory = () => {
  ...
  const employerPermission = savedRoles
    ...
    .find((child) => child.description === 'USERS HISTORY');
  ...
  return (
    <>
      <Helmet>
        <title>User History Report - C3wizard</title>
      </Helmet>
          ...
          <>
            <div className="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
              <ul className="d-flex align-items-center mt-3 gap-2 list-unstyled">
                ...
                <li>-</li>
                <li className="fw-medium">Adminstrative User History</li>
              </ul>
            </div>
